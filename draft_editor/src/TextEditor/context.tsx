...
export const useEditorApi = () => {
    ...
    if (context === undefined) {
        throw new Error('useEditorApi must be used with TextEditorProvider')
    }

    return context
}

type ITextEditorProviderProps = {
    children: React.ReactNode
}

export const TextEditorProvider: React.FC<ITextEditorProviderProps> = ({ children }) => {
